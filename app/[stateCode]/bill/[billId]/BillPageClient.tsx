...
export default function BillPageClient({ 
  ...
  const shareUrl = `${process.env.NEXT_PUBLIC_APP_URL}/${bill.state_abbr.toLowerCase()}/bill/${bill.bill_id}`;
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Share Card */}
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Share Bill</h3>
              <ShareButtons 
                url={shareUrl} 
                title={`${bill.state_name} ${bill.bill_number}: ${bill.title}`} 
