      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              Contact: <a href="mailto:info@voterai.chat" className="hover:text-zinc-800 dark:hover:text-zinc-300">info@voterai.chat</a>
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-300"
              >
